...
public class CSVFrame extends DockableFrame {
    ...
    public CSVFrame(String title, JToolBar jtb) {
        super(title, jtb);
        createAndShowGUI();
    }
    ...
    static JPanel createAboutPanel() {
        ...
        URL imageResource = CSVFrame.class.getResource("/icons8-slider-1024.png"); // URL: https://cdn.pixabay.com/photo/2012/05/04/10/57/gear-47203_1280.png
