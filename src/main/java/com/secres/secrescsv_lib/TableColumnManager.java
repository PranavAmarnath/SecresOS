...
/**
 * The TableColumnManager can be used to manage TableColumns. It will give the user the ability to hide columns and then reshow them in their last viewed position. This functionality is supported by a popup menu added to the table header of the table. The TableColumnModel is still used to control the view for the table. The manager will inovoke the appropriate methods of the TableColumnModel to hide/show columns as required.
 * 
 * @author Rob Camick
...
public class TableColumnManager implements MouseListener, ActionListener, TableColumnModelListener, PropertyChangeListener {
    ...
    public void setMenuPopup(boolean menuPopup) {
        ...
        if(menuPopup) table.getTableHeader().addMouseListener(this);
    ...
    public void propertyChange(PropertyChangeEvent e) {
        if("model".equals(e.getPropertyName())) {
            if(table.getAutoCreateColumnsFromModel()) reset();
        }
    }
